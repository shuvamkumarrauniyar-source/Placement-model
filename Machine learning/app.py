...
def get_page_html(result="", cgpa="", iq="", error=""):
    message = (
...
def home():
    if request.method == "POST":
        ...
        try:
            ...
            return render_template_string(get_page_html(result=result, cgpa=cgpa, iq=iq))
        except ValueError:
            return render_template_string(get_page_html(cgpa=cgpa, iq=iq, error="Enter a CGPA from 0 to 10 and a non-negative IQ."))
